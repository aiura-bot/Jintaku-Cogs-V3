    ...
    async def _search_anime_manga(self, ctx, cmd, entered_title):
        ...
        if data is not None and len(data) > 0:
            ...
            for anime_manga in data:
                ...
                if cmd == "ANIME":
                    embed.add_field(name="You can find out more", value=f"[Anilist]({link}), [MAL](https://myanimelist.net/{cmd.lower()}/{anime_manga['idMal']}), [Simkl](https://api.simkl.com/redirect?mal={anime_manga['id_mal']})")
                else:
